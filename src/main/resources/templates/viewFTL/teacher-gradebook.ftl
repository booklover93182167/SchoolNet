        ...
        <div class="col-sm-12 text-left">
            ...
            <#if model["courses"]??>
                <ul class="nav nav-pills">
                    <#list model["courses"] as course>
                        <li class="nav-item">
                            <a class="nav-link <#if model["course"]??><#if model["course"].id == course.id>active</#if></#if>" href="/freemarker/teacher-gradebook/${course.id}<#if model["sizes"]??>?size=${model["sizes"]}</#if>">${course.formName}, ${course.lessonName}</a>
                        </li>
                    </#list>
                </ul>
            </#if>
            ...
            <#if model["error"]??>
                ...
                <div class="alert alert-danger" role="alert">
                    <h3 class="alert-heading"><@spring.message "teacher.gradebook.error"/></h3>
