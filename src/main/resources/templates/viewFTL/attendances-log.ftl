...
<div class="container-fluid">
    ...
    <table class="table table-striped">
        <tr>
            ...
            <th><@spring.message "attendance.pupil"/>, <@spring.message "attendance.form"/></th>
            <th><@spring.message "attendance.lesson"/></th>
        </tr>
    <#list model.log as log>
        <tr>
            <td>${log.date.format('dd.MM.yyyy HH:mm')}</td>
            ...
            <td>${log.pupilFirstName} ${log.pupilLastName}, ${log.formName}</td>
