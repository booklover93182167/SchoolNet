    ...
    <div class="row content">
        ...
        <#else>
            ...
            <#list model["pupilList"] as pupil>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#pupil${pupil.id}" role="tab" aria-controls="pupil${pupil.id}" data-pupil-id="${pupil.id}" data-pupil-form-id="${pupil.formId}" data-pupil-form-school-enabled="${pupil.schoolEnabled?string('true', 'false')}">${pupil.firstName} ${pupil.lastName} [${pupil.formName}]</a>
                </li>
            </#list>
            </ul>
            <br>
